...
def ancestors(genealogy, person):
	if person not in genealogy:
		return []
	return genealogy[person] + ancestors(genealogy, genealogy[person][0]) + ancestors(genealogy,genealogy[person][1])

# Here are some examples:

print "Augusta Ada King =>", ancestors(ada_family, 'Augusta Ada King')
#>>> ['Anne Isabella Milbanke', 'George Gordon Byron',
#    'Catherine Gordon','Captain John Byron']

print 'Judith Blunt-Lytton =>', ancestors(ada_family, 'Judith Blunt-Lytton')
#>>> ['Anne Isabella Blunt', 'Wilfrid Scawen Blunt', 'Augusta Ada King',
#    'William King-Noel', 'Anne Isabella Milbanke', 'George Gordon Byron',
#    'Catherine Gordon', 'Captain John Byron']

print 'Dave =>', ancestors(ada_family, 'Dave')
#>>> []
